...
function numberOfCharacters(string) {
   ...
   return Object.keys(count).sort().reduce((acc, curr) => {
      acc[curr] = count[curr];
      return acc;
   }, {});
}
...
function capicua(numero) {
   ...
   const reverseStringNumero = stringNumero.split('').reverse().join('');
   return stringNumero === reverseStringNumero ? "Es capicua" : "No es capicua";
}
